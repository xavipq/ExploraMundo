...
public class DAODestinos {
    ...
    public Destinos Insertar(String NombreDestinos, String UbicacionDestinos, String DescripccionDestinos){
        String transaccion = "INSERT INTO Destinos (NombreDestinos, UbicacionDestinos, DescripcionDestinos)VALUES('"
                + NombreDestinos + "', '"
                + UbicacionDestinos + "', '"
                + DescripccionDestinos + "')" ;
         
         if (new DataBase().Actualizar(transaccion)> 0){
            return new Destinos(NombreDestinos, UbicacionDestinos, DescripccionDestinos);
...
public int Eliminar(int id){
    String transaccion = "DELETE FROM Destinos WHERE idDestinos='"+ id + "'";
